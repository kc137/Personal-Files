...
for prod in products:
    ...
    quantities.append(prod.quantity)
    ...
    def __init__(self):
        ...
        for i in range(N):
            if self.chromosome[i]:
                qty = random.randint(0, quantities[i])
                self.space += qty*spaces[i]
                self.score += qty*prices[i]
...
"""
Seed-1
The best solution found by GA for Knapsack problem : 58809.76$
Best solution found at Generation-191
58809.76 8.302049499999999 [1, 1, 1, 1, 1, 0, 0, 1, 0, 0, 0, 0, 0, 1]

Best solution found at Generation-111
61099.90000000001 9.905049499999999 [0, 1, 1, 1, 1, 1, 0, 0, 1, 1, 1, 0, 1, 1]
"""