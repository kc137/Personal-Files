...
class Genetic_Algorithm:
    ...
    def __init__(self, population_size = 200, crossover_rate = 0.8, mutation_rate = 0.1, num_gens = 150):
    ...
    def create_creators(self):
        creator.create("min_fitness", base.Fitness, weights = (-1, -1, ))
    ...
    def run_generations(self):
        ...
        while generations != self.num_gens:
            ...
            routes = best_individual.fitness.values[1]
...
GA = Genetic_Algorithm(200, 0.9, 0.1, 300)
GA.create_creators()
GA.popu_fitness()
GA.run_generations()                
...
nx.draw(G, pos = city_positions, with_labels = True, node_size = 500, node_color = node_colors, 
        node_shape = "o", edge_color = edge_colors, font_weight = "normal", 
        arrowsize = 5, arrowstyle = "->", font_color = "white", width = 1)

G.nodes["D"]["color"] = "red"

for veh in range(1, V+1):
    nx.draw_networkx_nodes(G, pos = city_positions, nodelist = nodes[veh], node_size = 500, 
