...
# model.obj_2 = pyo.Objective(rule = obj_fn_2, sense = pyo.minimize)
...
print(f"The total extra-workers required : {totSlack()} Workers.")

for w in workers:
    print(f"{w} : {totShifts[w]()}")
...
# print(f"The total shifts : {model.obj_2()} Workers.")
